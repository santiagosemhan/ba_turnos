...
class UsuarioSedeFilterType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder->add('sede',EntityType::class,array('class' => 'AdminBundle:Sede','choice_label' => 'Sede','required'=>false,'attr'  => array('class'=>"select2")))
